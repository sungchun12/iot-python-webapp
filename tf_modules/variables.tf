...
variable "api_services" {
  ...
  type        = list
  default     = ["iam.googleapis.com", "cloudresourcemanager.googleapis.com", "cloudfunctions.googleapis.com", "pubsub.googleapis.com", "storage-component.googleapis.com", "bigquery.googleapis.com", "cloudbuild.googleapis.com", "run.googleapis.com", "cloudiot.googleapis.com", "bigtable.googleapis.com", "bigtableadmin.googleapis.com", "dataflow.googleapis.com", "compute.googleapis.com", "cloudkms.googleapis.com"]
}
