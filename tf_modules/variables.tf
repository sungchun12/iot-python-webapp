...
variable "api_services" {
  ...
  type        = list
  default     = ["iam.googleapis.com", "cloudresourcemanager.googleapis.com", "cloudfunctions.googleapis.com", "pubsub.googleapis.com", "storage-component.googleapis.com", "bigquery-json.googleapis.com", "cloudbuild.googleapis.com"]
}
